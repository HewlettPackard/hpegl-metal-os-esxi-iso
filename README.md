...
Step 2. Download the ESXi .ISO image to your local build environment via whatever method you prefer (Web Browser, etc)
...
Here are some points to note:
  ...
  * HPE GreenLake Metal tools do not monitor the serial port(s) at this time so if an error is generated by the ESXi installer, the Bare Metal tools will not know about it.
